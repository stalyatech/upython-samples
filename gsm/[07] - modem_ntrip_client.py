...
zed1.parser(UART.ParserUBX, rxbuf=1024, rxcallback=OnUbloxMsg, frcallback=OnUbloxParsedZED1)
zed2.parser(UART.ParserUBX, rxbuf=1024, rxcallback=OnUbloxMsg, frcallback=OnUbloxParsedZED2)
